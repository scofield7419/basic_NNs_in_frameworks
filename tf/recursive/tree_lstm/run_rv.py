from tree_data import load_sentiment_treebank, get_max_len_data, get_max_node_size
...
DIR = r'/Users/scofield/workplaces/pythons/deep_networks/scott_trials/basic_trials/tf/recursive/tree_lstm/data/sst/'
GLOVE_DIR = './'
...
def train(restore=False):
    ...
    data, vocab = load_sentiment_treebank(DIR, config.fine_grained)
    ...
    with tf.Graph().as_default():
        ...
        model = rv_tree_lstm.tf_NarytreeLSTM(config)
